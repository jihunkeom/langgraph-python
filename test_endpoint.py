...
def test_thread_id_conversation_memory():
    ...
    try:
        ...
        print(f"첫 번째 응답: {json.dumps(response1.json(), indent=2, ensure_ascii=False)}")
        ...
        print(f"두 번째 응답: {json.dumps(response2.json(), indent=2, ensure_ascii=False)}")
        ...
        print(f"세 번째 응답: {json.dumps(response3.json(), indent=2, ensure_ascii=False)}")
